...
class ModelTraining:
    def __init__(self):
        ...
        self.model = DecisionTreeClassifier(random_state=42,criterion="gini",max_depth=30)
    ...
    def evaluate(self,X_test,y_test):
        try:
            ...
            confusion_matrix_path = os.path.join(self.model_path,"confusion_martix.png")
            ...
            logger.error(f"Error while evalutaing the model {e}")
